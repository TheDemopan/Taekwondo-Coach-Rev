...
numberOfImages = 15
parentDir = 'C:\\Users\\srisu\\OneDrive\\Documents\\Laptop-tkd-dev\\Taekwondo-Coach-Rev\\raw-capture'
...
for status in labels:
    ...
    for img in range(numberOfImages): # for every image in the predefined range (30)
        print("Image " + str(c) + "/15 for status {}".format(status)) # print the status log
        ret, frame = cap.read()
